            ...
            <div className="w-full max-w-sm p-6 bg-white rounded-lg shadow-md">
                ...
                <form onSubmit={submitHandler} className="space-y-4">
                    <div>
                        ...
                        {/* If you are usign value you need to use onChange */}
                        <input
                            type="text"
                            id="username"
                            name="username"
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={changeHandler}
                            className="ml-2 px-3 py-2 border rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 border-gray-300"
                        />
                    </div>
